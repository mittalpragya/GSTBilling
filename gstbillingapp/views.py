...
def invoice_create(request):
    ...
    context = {}
    context['default_invoice_number'] = Invoice.objects.filter(user=request.user).aggregate(Max('invoice_number'))[
        'invoice_number__max']
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'gstbillingapp/empty_invoice_created.html', context)
